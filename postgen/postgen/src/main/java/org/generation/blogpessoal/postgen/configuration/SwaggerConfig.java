package org.generation.blogpessoal.postgen.configuration;
...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).select()
				.apis(RequestHandlerSelectors.basePackage("org.generation.blogpessoal.postgen.controller"))
	...
	public static ApiInfo metadata() {
		return new ApiInfoBuilder().title("API - blog").description("Projeto API Spring - Meu blog")
				.version("1.0.0").license("Apache License Version 2.0").licenseUrl("https://github.com/DanielDezena/")
				.contact(contact()).build();
	}

	private static Contact contact() {
		return new Contact("Daniel Dezena", "https://github.com/DanielDezena/", "danieldezena098@gmail.com");
	}
